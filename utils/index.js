    ...
    message: {
      attachment: {
        ...
        payload: {
          ...
          elements: [{
            title: "Welcome to Amplify DashBot",
            buttons: [{
              type: "account_link",
...
module.exports.receivedPostback = function(user_response) {
  var action = user_response.postback.payload;
  console.log('+++++++ receivedPostback  ', action);
